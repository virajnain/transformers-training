...
class ForecastingModel(torch.nn.Module):
    def __init__(self, 
        ...
        if conv1d_emb:
            ...
            self.input_embedding  = nn.Conv1d(2, embed_size, kernel_size=conv1d_kernel_size)
        else: self.input_embedding  = nn.Linear(2, embed_size)
        ...
        self.outlayer = nn.Linear(int(dim_feedforward/64), 2)
